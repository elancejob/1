...
public class CirclePageTransformer implements ViewPager.PageTransformer{
     ...
     */
    public CirclePageTransformer(int degrees){
        this(degrees, 0.7f);
    }
     ...
     */
    public CirclePageTransformer(int degrees, float minAlpha){
